...
<head>
    <title>Dia 31/07/2018 - Agenda das Obrigações Tributárias - Link Contábil</title>
...
<body>
    ...
    <section class="container content agenda-tributaria">
        ...
        <h3>OBRIGAÇÕES TRIBUTÁRIAS:<br /><small>31/07/2018</small></h3><hr />
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td>0211</td>
                    <td>4ª quota do imposto apurado na Declaração de Ajuste Anual</td>
                    <td>Ano-Calendário 2017</td>
                </tr>
                <tr>
                    <td>2927</td>
                ...
                <tr>
                    ...
                    <td><span>Abril a Junho/2018</span></td>
                </tr>
                <tr>
                    <td>2362</td>
                ...
                <tr>
                    ...
                    <td>1º a 15/julho/2018</td>
                </tr>
                <tr>
                    <td>3746</td>
                    <td>COFINS - Retenção - Aquisição de autopeças</td>
                    <td><span>1º a 15/julho/2018</span></td>
                </tr>
                <tr>
                    <td>2030</td>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td>DAS-MEI (Documento de Arrecadação Simplificada do Microempreendedor Individual)</td>
                    <td>Programa Especial de Regularização Tributária das Microempresas e Empresas de Pequeno Porte optantes pelo Simples Nacional (Pert-SN) Microempreendedor Individual</td>
                    <td>Diversos</td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <tr>
                    <td><strong>DME</strong> - Declaração de Operações Liquidadas com Moeda em Espécie</td>
                    <td>Junho/2018</td>
                </tr>
                <tr>
                    <td><strong>DIPI - TIPI 33</strong> - produtos de higiene pessoal, cosméticos e perfumaria.</td>
                    <td>Maio e Junho/2018</td>
                </tr>
                <tr>
                    <td><strong>DPREV</strong> - Declaração sobre a Opção de Tributação de Planos Previdenciários</td>
                    <td>Ano-calendário de 2017</td>
                </tr>
                <tr>
                    <td><strong>ECF</strong> - Escrituração Contábil Fiscal</td>
                    <td>Ano-calendário de 2017</td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>Declarações, Demonstrativos e Documentos de Interesse Principal das Pessoas Físicas</th>
                    <th>PERÍODO</th>
                </tr>
            </thead>
            <tbody>
