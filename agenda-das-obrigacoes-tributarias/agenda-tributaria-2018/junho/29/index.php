...
<head>
    <title>Dia 29/06/2018 - Agenda das Obrigações Tributárias - Link Contábil</title>
...
<body>
    ...
    <section class="container content agenda-tributaria">
        ...
        <h3>OBRIGAÇÕES TRIBUTÁRIAS:<br /><small>29/06/2018</small></h3><hr />
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td>0211</td>
                    <td>3ª quota do imposto apurado na Declaração de Ajuste Anual</td>
                ...
                <tr>
                    ...
                    <td>1º a 15/junho/2018</td>
                </tr>
                <tr>
                    <td>3746</td>
                    <td>COFINS - Retenção - Aquisição de autopeças</td>
                    <td><span>1º a 15/junho/2018</span></td>
                </tr>
                <tr>
                    <td>2030</td>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td><span>DAS (Documento de Arrecadação do Simples Nacional)</span></td>
                ...
                <tr>
                    <td><span>DAS-MEI (Documento de Arrecadação Simplificada do Microempreendedor Individual)</span></td>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td><strong>e-Financeira</strong></td>
