...
<head>
    <title>Dia 23/05/2018 - Agenda das Obrigações Tributárias - Link Contábil</title>
...
<body>
    ...
    <section class="container content agenda-tributaria">
        ...
        <h3>OBRIGAÇÕES TRIBUTÁRIAS:<br /><small>23/05/2018</small></h3><hr />

        <table class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th>DARF</th>
                    <th>TRIBUTO | CONTRIBUIÃO</th>
                    <th>PERÍODO</th>
                </tr>
            </thead>
            <tbody>
