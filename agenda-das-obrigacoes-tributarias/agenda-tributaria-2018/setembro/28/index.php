...
<head>
    <title>Dia 28/09/2018 - Agenda das Obrigações Tributárias - Link Contábil</title>
...
<body>
    ...
    <section class="container content agenda-tributaria">
        ...
        <h3>OBRIGAÇÕES TRIBUTÁRIAS:<br /><small>28/09/2018</small></h3><hr />
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td>0211</td>
                    <td>6ª quota do imposto apurado na Declaração de Ajuste Anual</td>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td><strong>PERC</strong> - Pedido de Revisão de Ordem de Emissão de Incentivos Fiscais</td>
                    <td>Exercício - 2016 Ano-Calendário - 2015</td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th>Declarações, Demonstrativos e Documentos De Interesse Principal do Proprietário de Imóvel Rural</th>
                    <th>PERÍODO</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td><strong>DITR</strong> - Declaração do Imposto sobre a Propriedade Territorial Rural</td>
                    <td>Exercício 2018</td>
                </tr>
            </tbody>
        </table>
