...
<head>
    <title>Aviso Prévio Indenizado - Documentos Importantes - Link Contábil</title>
...
<body>
    ...
    <section class="container">
        ...
        <div class="description-doc col-md-10">
            <small>Desenvolvemos este modelo de Aviso Prévio Indenizado para facilitar o seu dia-a-dia e contribuir para o sucesso do seu trabalho.</small> <small>Basta preencher os campos abaixo e gerar seu 
        ...
        <div class="col-md-12 formulario">
            ...
            <form action="geradoc.php" method="POST" enctype="multipart/form-data" name="geradoc" autocomplete="off">
                ...
                <h3 align="center">AVISO PRÉVIO INDENIZADO</h3>
