...
<body>
    ...
    <section class="container">
        ...
        <div class="description-doc col-md-10">
            <small>Desenvolvemos este modelo de Carta de Advertência para facilitar o seu dia-a-dia e contribuir para o sucesso do seu trabalho.</small> <small>Basta preencher os campos abaixo e gerar seu 
        ...
        <div class="col-md-12 formulario">
            ...
            <form action="geradoc.php" method="POST" enctype="multipart/form-data" name="geradoc" autocomplete="off">
                ...
                <h3 align="center">CARTA DE ADVERTÊNCIA</h3>
                <span class="sublinhado"></span>

                <div class="col-md-6">
                    <label for="data">Data da Advertência:</label><br />
                ...
                <div class="col-md-12">
                    <label for="fatos">Descreva os fatos que levaram o(a) funcionário(a) a ser advertido(a):</label><br />
