jQuery(function($){
     ...
     $("#data_p").mask("99/99/9999",{placeholder:"DD/MM/AAAA"});
     $("#dia_nota").mask("99/99/9999",{placeholder:"DD/MM/AAAA"});
     $("#cnpj").mask("99.999.999/9999-99",{placeholder:"00.000.000/0000-00"});
     $("#i_estadual").mask("999.999.999.999",{placeholder:"000.000.000.000"});
     $("#cep").mask("99999-999",{placeholder:"00000-000"});
     $("#cep_e").mask("99999-999",{placeholder:"00000-000"});
});
