...
<head>
    <title>Carta de Suspensão - Impressão - Link Contábil</title>
...
<body>
    ...
    <header class="container header">
        ...
        <h4 class="data" align="right"><?php $cidade = $_POST['cidade']; echo "$cidade" ?>, <?php $data = $_POST['data']; echo "$data" ?></h4><br />
    </header>

    <section class="container documento">

        <h3 align="center"><strong>SUSPENSÃO</strong></h3><br />

        <p>Prezado(a) Sr.(a): <?php $nome_funcionario = $_POST['nome_funcionario']; echo "$nome_funcionario" ?></p><br />

        <p>Através desta, fica o(a) Sr.(a), funcionário desta empresa, suspenso(a), pelo prazo de <strong><?php $numero_dias = $_POST['numero_dias']; echo "$numero_dias" ?></h4></strong> dias, a contar de hoje, de acordo com a C.L.T. (CONSOLIDAÇÃO DAS LEIS DO TRABALHO), pelo seguinte motivo:</p>
